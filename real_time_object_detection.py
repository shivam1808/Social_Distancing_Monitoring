...
vid = "/home/shivam-gupta/Desktop/mlops-ws/Realtime Object Detection(Using SSD MobileNet)/video4.mp4"
...
while True:
	...
	for i in np.arange(0, detections.shape[2]):
		...
		if (probability > args["probability"]) and (int(detections[0, 0, i, 1]) == 15):
